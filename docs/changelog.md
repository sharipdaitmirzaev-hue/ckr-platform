...
- Единая структура разделов; компактный header + полное мобильное меню
- Главная: 4 intent CTA (бизнес / идея / ресурсы / партнёрство) + путь без тупиков
- Роли: кому / проблема / как ЦКР / следующий шаг
- Лия: CTA «Расскажите о вашей задаче» → аудит → рекомендации → проект
- Marketplace-карточки: описание, статус, действие; `/trust` — проверка и принципы
- SEO/OG/sitemap; analytics events проверены; docs: `website-finalization.md`
