...
/** Сценарий «Готов ли ЦКР к публичному запуску?» (этап 57, только анализ). */
export type PublicLaunchDecisionReport = {
  summary: string;
...
/** Сценарий «Как проходит публичный запуск ЦКР?» (этап 58, только анализ). */
export type PublicLaunchReport = {
  summary: string;
  users: string[];
  activation: string[];
  ecosystem: string[];
...
/** Сценарий «Как проходит запуск ЦКР сейчас?» (этап 59, только анализ). */
export type LiveLaunchReport = {
  summary: string;
  users: string[];
  activity: string[];
  ecosystem: string[];
...
/** Сценарий «Как развивается поток проектов ЦКР?» (этап 61, только анализ). */
export type ProjectAcquisitionReport = {
  summary: string;
  sources: string[];
  conversion: string[];
  quality: string[];
