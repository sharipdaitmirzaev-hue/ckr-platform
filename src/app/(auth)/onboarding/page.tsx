  ...
  return (
    <Card as="div" variant="surface" className="p-6 sm:p-8">
      ...
      <p className="mt-2 text-sm text-muted">
        Выберите роль — платформа покажет короткий путь: предприниматель
        Идея→Проект, эксперт Профиль→Доверие→Запросы, инвестор
        Проекты→Интерес, организация Потребность→Партнёры.
      </p>
