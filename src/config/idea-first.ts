...
export const IDEA_FORM = {
  ...
  contactPrompt:
    "Оставьте телефон или почту — так ЦКР сможет ответить. Достаточно одного способа.",
  contactPhoneLabel: "Телефон / WhatsApp",
  contactEmailLabel: "Электронная почта",
  contactTelegramLabel: "Telegram (по желанию)",
  contactHint: "Без контакта мы примем идею, но не сможем быстро связаться с вами.",
